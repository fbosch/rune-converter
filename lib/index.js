...
function transcribeLetterCombinations(string) {
  ...
  return combinations.reduce((str, key) => str = replace(str, key, transcribe(key)), toLower(clone(string)))
}
...
export { transcribe, transcribeLetterCombinations, toRunic, elderFuthark, transcriptionTable }
